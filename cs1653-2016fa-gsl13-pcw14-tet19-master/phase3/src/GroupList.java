...
import java.util.*;
	...
	public class GroupList implements java.io.Serializable {
		...
		public GroupList(Hashtable<String, Group> list){
			this.list = list;
		}
		...
		public GroupList deepCopyList(){
			Hashtable<String, Group> copyTable = new Hashtable<String, Group>();
			for (String s : list.keySet()){
				Group g = list.get(s);
				Group gCopy = g.deepCopyGroup();
				copyTable.put(s,gCopy);
			}
			GroupList listCopy = new GroupList(copyTable);
			return listCopy;
		...
		public String toString(){
			...
			for (String name : list.keySet()){
				s.append ("Group name: " + name + "; Group Info: ");
				Group g = list.get(name);
				s.append(g);
			}
			return s.toString();
		}
	...
	class Group implements java.io.Serializable {
		...
		public Group(ArrayList<String> members, String ownership)
		{
		...
		public Group deepCopyGroup() {
			ArrayList<String> copyMembers = new ArrayList<String>();
			for (String s : this.members)
				copyMembers.add(s);
			Group copyGroup = new Group(copyMembers, ownership);
			return copyGroup;
		}

		public String toString() {
			StringBuilder s = new StringBuilder();
			s.append("Owner " + this.ownership);
			s.append("; Members: ");
