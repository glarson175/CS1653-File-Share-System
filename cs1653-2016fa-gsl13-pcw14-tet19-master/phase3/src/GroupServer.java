...
public class GroupServer extends Server {
    ...
    FileInputStream gis = null;
		...
		try
		{
			...
			System.out.println("Successful read of UserList.bin, GroupList.bin, and Database.bin");
		...
		catch(FileNotFoundException e)
		{
			...
			System.out.println("UserList.bin, GroupList.bin, or Database.bin Does Not Exist. Creating new files...");
		...
		{
			System.out.println("Error reading from UserList /GroupList/Database file");
      e.printStackTrace();
		}
