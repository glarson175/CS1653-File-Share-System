...
import java.util.*;
	...
	public FileList(ArrayList<ShareFile> list)
	{
		this.list = list;
	}
	...
	public FileList deepCopy() {
		ArrayList<ShareFile> listCopy = new ArrayList<ShareFile>();
		for (ShareFile f : list)
			listCopy.add(f);
		FileList copy = new FileList(listCopy);
		return copy;
	}
}
