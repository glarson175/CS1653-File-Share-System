...
public interface FileClientInterface
{
     ...
     *
     */
    public boolean upload(final String sourceFile, final String destFile, final String group, final UserToken token, final int versionNumber, final FileKeyPair fkp);
     ...
     *
     */
    public boolean download(final String sourceFile, final String destFile, final UserToken token, final String groupname);
